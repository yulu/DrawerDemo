package com.littlecheesecake.drawerdemo.layout;
...
/**
 * Created by luyu on 7/11/14.
 * Attach an View.OnTouchListener to it to support fling and drag & drop
 */
public class MainLayout extends LinearLayout {
    ...
    private static final float MENU_MARGIN_RATIO = 0.3f;
    ...
    //menu right margin
    private static int menuRightMargin = 20;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        menuRightMargin = (int) (mainLayoutWidth * MENU_MARGIN_RATIO);
    }
    ...
    public void toggleMenu() {
        ...
        //invalidate the whole layout, cause onLayout to be called
        this.invalidate();
    }
    ...
    public boolean onContentTouch(View v, MotionEvent event) {
        ...
        switch(event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                Log.d("Guesture", String.valueOf(lastDiffX));
